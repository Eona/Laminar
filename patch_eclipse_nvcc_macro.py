...
# Eona studio (c) 2015
#
# THIS FILE ONLY MODIFIES macros in .cproject
#
# The following is from project 'MyCmake', which uses Eclipse Luna
# that supports separate source dirs much better. 
# Nsight eclipse indexer is really outdated. 
#
